...
function ResultsTable({ details, currentClasses }) {
  ...
  const binImages = {
    ...
    "wine glass": "./assets/GLAS.jpg",
    "cup": "./assets/GLAS.jpg",
    "bowl": "./assets/GLAS.jpg",
    ...
    "banana": "./assets/MADAFFALD.jpg",
    "apple": "./assets/MADAFFALD.jpg",
    "sandwich": "./assets/MADAFFALD.jpg",
    "carrot": "./assets/MADAFFALD.jpg",
    "pizza": "./assets/MADAFFALD.jpg",
